...
3. Upload the compressed file that contains each omics measurement profile in a separate Excel file. All tables must have the same contrasts if you want to combine them. The column 'Protein' must be present for the contrasts and omics profiles for which you have measurements. Use UniProt IDs.
